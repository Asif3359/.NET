    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<ActionResult<OrderResponseDto>> CreateOrder([FromBody] OrderDto orderDto)
        {
            ...
            foreach (var itemDto in orderDto.Items)
            {
                ...
                if (itemDto.Quantity > 100) // Limit quantity
                ...
                var orderItem = new OrderItem
                {
                    ...
                    UnitPrice = product.Price // Store price snapshot
                };
        ...
        // GET: api/orders/user/5 - Get orders for specific user (Admin only)
        [HttpGet("user/{userId}")]
        ...
        // GET: api/orders/status/pending - Get orders by status (Admin only)
